...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btt_regresar->Margin = System::Windows::Forms::Padding(2);
			...
			this->pnl_menu->Margin = System::Windows::Forms::Padding(2);
			...
			this->btt_mostrar->Location = System::Drawing::Point(401, 24);
			this->btt_mostrar->Margin = System::Windows::Forms::Padding(2);
			...
			this->btt_insertar->Location = System::Drawing::Point(166, 24);
			this->btt_insertar->Margin = System::Windows::Forms::Padding(2);
			...
			this->pnl_contenedor->Margin = System::Windows::Forms::Padding(2);
